...
def run_simulation(parameters: tuple[float, float], initial_opinion: np.ndarray,
                   initial_infected: int, choice: str, max_t: int) -> tuple[np.ndarray, np.ndarray]:
...
def composite_loss(parameters: tuple[float, float], opinion_data: np.ndarray, opinion_idx: np.ndarray, infection_data: np.ndarray,
                   infection_idx: np.ndarray, initial_opinion: np.ndarray,  initial_infected: int, choice: str,
                   number_of_simulations: int) -> tuple[float, float]:
...
def loss(parameters, opinion_data, opinion_idx, infection_data, infection_idx, initial_infected, choice, pool):
